...
{
	char buf[30], buf2[30];
	static const float degrees[] = {0.0, 30.0, 45.0, 60.0, 90.0, 120.0, 135.0, 150.0, 180.0, 210.0, 225.0, 240.0, 270.0, 300.0, 315.0, 330.0, 360.0};
	float angle;
...
void testconv(void)
{
	int i;
	fixed_t val_fix[5];
	static const float val_float[5] = {-225.12345, -99.555, 0.0, 99.666, 225.12345};
	float val_float2[5];
	char buf[30];
