...
int32_t app_main(void)
{
	...
	id1 = ucx_timer_create(timer1, 1000);
	id2 = ucx_timer_create(timer2, 3000);
	id3 = ucx_timer_create(timer3, 500);
	id4 = ucx_timer_create(timer4, 10000);
	id5 = ucx_timer_create(timer5, 5000);
