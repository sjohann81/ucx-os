...
ASFLAGS = 
CFLAGS = -c -g -mmcu=atmega2560 -Wall -Os -fno-inline-small-functions -Wno-pointer-to-int-cast -Wno-int-to-pointer-cast -Wno-main -fomit-frame-pointer -D F_CPU=$(F_CLK) -D USART_BAUD=$(SERIAL_BAUDRATE) -DF_TIMER=${F_TICK} $(INC_DIRS) -D UNKNOWN_HEAP
ARFLAGS = r
LDFLAGS = -g -mmcu=atmega2560 -Wall -Os -fno-inline-small-functions -Wno-pointer-to-int-cast -Wno-int-to-pointer-cast -Wno-main -fomit-frame-pointer -D F_CPU=$(F_CLK) -D USART_BAUD=$(SERIAL_BAUDRATE) -DF_TIMER=${F_TICK} $(INC_DIRS) -D UNKNOWN_HEAP
LDSCRIPT = 
