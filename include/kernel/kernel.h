...
/* kernel API */
#define CRITICAL_ENTER()({kcb->preemptive == 'y' ? _disable_interrupt_() : 0; })	// shouln't be always _di()?
#define CRITICAL_LEAVE()({kcb->preemptive == 'y' ? _enable_interrupts() : 0; })	// shouln't be always _ei()?
